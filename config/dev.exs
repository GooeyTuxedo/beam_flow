...
config :beam_flow, BeamFlowWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "XxUu3SVv+p+/NGsdx0M9uzFGJ2R1eoGzSnJXfiNRAantwOQlneM2tPtAfk3OnrCm",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:beam_flow, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:beam_flow, ~w(--watch)]}
  ]
