defmodule BeamFlowWeb.Telemetry do
  ...
  def metrics do
    [
      ...
      # Database Metrics
      summary("beam_flow.repo.query.total_time",
        unit: {:native, :millisecond},
        description: "The sum of the other measurements"
      ),
      summary("beam_flow.repo.query.decode_time",
        unit: {:native, :millisecond},
        description: "The time spent decoding the data received from the database"
      ),
      summary("beam_flow.repo.query.query_time",
        unit: {:native, :millisecond},
        description: "The time spent executing the query"
      ),
      summary("beam_flow.repo.query.queue_time",
        unit: {:native, :millisecond},
        description: "The time spent waiting for a database connection"
      ),
      summary("beam_flow.repo.query.idle_time",
        unit: {:native, :millisecond},
        description:
